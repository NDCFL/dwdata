...
public class FengXianPingGuUtil {
    ...
    public static void httpURLConectionGET() {
        try {
            URL url = new URL(GET_URL+"?name="+ URLEncoder.encode("王维朕","utf-8")+"&idcard=411324199707220011");    //把字符串转换为URL请求地址
            ...
            String sign = "1121688520430811"+time+"DtMbOuHeeDSOUZPy2nY53HnDHPvoeB91";
     ...
     * 接口调用  POST
     */
    public static void httpURLConnectionPOST(String path) {
        try {
            //传递参数
            String Parma = "name="+ URLEncoder.encode("冉华松","utf-8")+"&identityNo=421087199308108218&mobile=18522179401";
    ...
    public static void main(String arg[]){
        httpURLConnectionPOST("https://api.yongxunzhengxin.com/risk/v1/riskEvaluation");
    }
}
