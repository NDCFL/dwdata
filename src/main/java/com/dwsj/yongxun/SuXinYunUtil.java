...
public class SuXinYunUtil {
    ...
    public static void main(String arg[]){
        ...
        String sign = timeStamp + randomStr + "510922199707290290" + SysConf.SXY_TOKEN;
        sign = DigestUtils.shaHex(sign);
        sign = MD5Utils.getMD5Str(sign);
        sign = sign.toUpperCase();
        httpURLConnectionPOST("https://newapi.sujiexing.com/api/respond","uid=1001&timeStamp="+timeStamp+"&randomStr="+randomStr+"&idCard=510922199707290290&sign="+sign);
    }
}
