            ...
            <form class="form-horizontal" method="post" id="update_status">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">平台Cookie状态：</label>
                        <div class="col-sm-8">
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="updateform" >
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">平台Cookie：</label>
                        <div class="col-sm-8">
                            <input  name="cookie" class="form-control" id="cookie" required="" value="" aria-required="true"/>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
...
<script src="<%=path%>/static/js/pageJs/replaceableCookie.js"></script>
</body>
<%--<script>--%>
<%--$(function () {--%>
<%--alert("asdflsfa");--%>
