...
<div class="hui-wrap">
    <div class="hui-common-title" style="margin-top:15px;">
        <div class="hui-common-title-txt" style="font-weight: bold;font-size: 16px;width: 100%;">高级认证服务费用</div>
    </div>
    <div class="hui-common-title">
        <div class="hui-common-title-txt" style="font-size: 36px;margin-right: 10px;">￥3.90</div>
    </div>
    <div class="hui-list" style="margin-top:22px;">
        <div style="height: 60px;">
            ...
            <div style="height: 60px;">
                <div style="width: 70%;height: 100%;float: left;margin-left: 10px;">
    ...
    <div style="text-align: center;margin: auto;margin-top: 12px;">
        <form role="form"  id="money" action="<%=path%>/pay/pay">
