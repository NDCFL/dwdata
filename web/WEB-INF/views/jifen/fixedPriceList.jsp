            ...
            <form class="form-horizontal" id="updateform" >
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">积分：</label>
                        <div class="col-sm-8">
                            <input  name="price" class="form-control" id="price" required="" value="" aria-required="true"></input>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">介绍：</label>
                        <div class="col-sm-8">
                            <textarea  name="introduce" class="form-control" id="introduce" required="" value="" aria-required="true"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
...
<script src="<%=path%>/static/js/pageJs/fixedPrice.js"></script>
</body>
<%--<script>--%>
<%--$(function () {--%>
<%--alert("asdflsfa");--%>
