...
<head>
    <meta charset="UTF-8">
    <title>电商出行</title>
    <link rel="stylesheet" type="text/css" href="<%=path%>/static/dwpcpage/css/dianshang.css" />
...
<div class="main">
    <div class="main_samll">
        ...
        <div class="detail_cont">
            <div class="nav_small">
                <ul class="ns_ul">
                    <li style="color: #0583CE;background: #fff;">淘宝/京东/支付宝</li>
                    <li style="margin-left: 0.5%;">滴滴</li>
                    <li style="margin-left: 0.5%;">脉脉</li>
                </ul>
                <div class="tab_cont">
                    <div class="tab_box">
                        <div id ="is_show">
                            <ul class="tab_box2">
                                <li style="color: #000;">请<span style="color: red">截图</span>分享给被查询人，扫码方认证完成后，数据会自动刷新</li>
                                <li>
                                    <button id="find_btn">获取二维码</button>
                            ...
                            <p class="tab_box2_p">扫描即代表您同意<a href="/tbxy.jsp">《淘宝/京东/支付宝授权协议》</a></p>
                            <div class="table22">
                                <div class="table11">
                                    <table class="table table-hover" id="dianshang">
                    ...
                    <div class="tab_box" style="display: none;">
                        <div class="img_ing" id="is_show_1"><img src="<%=path%>/static/dwpcpage/images/ing.png" alt="" /></div>
                    </div>
                    <div class="tab_box" style="display: none;">
...
<div class="modal fade" id="qrimg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog" style="width: 500px;border-radius: 0px;height: 400px">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div style="text-align: center;margin: auto">
                    <p style="text-align:center;font-size: 14px">请<span style="color: red">截图</span>分享给被查询人，完成认证后，点击查看详情</p>
...
<script src="<%=path%>/static/dwpcpage/js/dianshang.js"></script>
...
<script src="<%=path%>/static/js/pageJs/dianshang.js"></script>
<script>
