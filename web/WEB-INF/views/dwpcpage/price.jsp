...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=path%>/static/dwpcpage/css/bootstrap.min.css"/>
    ...
    <div class="main_samll">
        <div class="ms_left">
            ...
            <ul class="msl_ul">
                ...
                <li><div class="msl_img img2"></div><span class="msl_span1"><a href="/pcUser/price" class="demo">功能价格</a></span></li>
        ...
        <div class="ms_right">
            <table class="table table-hover">
                ...
                <tr v-for="price in prices">
                    <td>{{price.name}}</td>
                    <td>{{price.introduce}}</td>
                    <td>
                        <span v-if="price.price>0">{{price.price}}</span>
                        <span v-else-if="price.price==0">网页端免费</span>
                        <span v-else>即将公布</span>
                    </td>
                    <td>{{price.remark}}</td>
                </tr>
                </tbody>
