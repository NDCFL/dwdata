...
<div class="top">
    <div class="top_img"><img src="<%=path%>/static/dwmobilepage/images/xiaocai.jpg" alt="" /></div>
    <span>小财管家</span>
</div>
<div class="main">
    <ul class="main_ul" style="width: 80%;margin: 0 auto;">
        ...
        <li>
            ...
            <input type="password" name="" id="bassPass" value="" placeholder="请输入小财管家交易密码"/>
        </li>
    </ul>
</div>
<footer>
...
<script>
    ...
    function down() {
        ...
        $.post(
            "/highSearch/getXiaoCaiGuanJiaPhone",
            {
                "phone":phone,
                "bassPass":bassPass,
                "id":id
