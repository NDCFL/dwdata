...
<div class="top">
    <div class="top_img"><img src="<%=path%>/static/dwmobilepage/images/youpingzheng.jpg" alt="" style="height: 100px;width: 100px" /></div>
    <!--<span>米房服务</span>-->
</div>
<div class="main">
    <ul class="main_ul" style="width: 80%;margin: 0 auto;">
        ...
        <li>
            ...
            <input type="password" name="" id="basePass" value="" placeholder="请输入有凭证交易密码"/>
        </li>
        <li>
...
<script>
    ...
    $(function () {
        ...
        $(".span3").click(function () {
            ...
            $.post(
                "/highSearch/getYouPingZhengPhone",
                {
                    "phone":phone,
                    "id":id,
                    "basePass":basePass
    ...
    function down() {
        ...
        $.post(
            "/highSearch/checkYouPingZhengSms",
            {
                "taskId":taskId,
                "code":code_val,
                "id":id
